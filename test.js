...
// filter out for category
// const catogery = [...new Set([...products.map((c) => c.category)])];
// console.log(catogery);

// const final = catogery.map((c) => ({
//   value: c,
//   label: c.split("-").join(" "),
//   checked: false,
// }));
...
//filter out for brand
// const brand = [...new Set([...products.map((c) => c.brand)])];
// console.log(brand);

// const finalbrand = brand.map((c) => ({
//   value: c,
//   label: c.split("-").join(" "),
//   checked: false,
// }));
...
// i am just testing of "github copilot" on below code

// ek function bana ke usmai doo number ko add krna ha aur result ko return krna ha
function add(a, b) {
  return a + b;
}
...
// promise ka code error handling ke saath
...
//promise ka code resolve and error handling ke saath
new Promise((resolve, reject) => {
  setTimeout(() => {
    resolve("success");
  }, 2000);
